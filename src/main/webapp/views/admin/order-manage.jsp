	...
	<div class="content">
		<div class="main-content">
			<div class="inline-div">
				...
				<button class="btn btn-primary btn-border-none pull-right left-margin-1x right-margin-3x disabled" href="#">操作模式</button>
				<button class="btn btn-primary btn-border-none pull-right left-margin-1x" href="#">查看模式</button>
			</div>
			<div class="wrap">
				<span id="search"></span>
